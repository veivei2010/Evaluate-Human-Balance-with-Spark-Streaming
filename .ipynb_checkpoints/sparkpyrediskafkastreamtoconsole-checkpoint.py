...
# /data/kafka/bin/kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server --from-beginning
...
# /data/kafka/bin/kafka-console-consumer --bootstrap-server localhost:9092 --topic stedi-events --from-beginning
